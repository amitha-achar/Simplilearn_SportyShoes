...
<form name=frmProduct method=post action="admineditproductaction" enctype="multipart/form-data">
...
<table border=1 cellspacing=2 cellpadding=4>
 	...
 	<tr>
 		...
 		<td>
 			<input type="file"  name=filepath value="{product.filepath}" style="display: inline;">
 		</td>
 	</tr>
